...
const CustomTooltip: React.FC<CustomTooltipProps> = ({
  ...
  if (active && payload && payload.length) {
    ...
    const decimalValue =
      typeof data.decimalValue === 'number'
        ? data.decimalValue.toFixed(2)
        : 'N/A';
...
const DisplayStreamsData: React.FC<DisplayStreamsDataProps> = ({ rawData }) => {
  const { time, values, decimalValues, senders, receivers, averageValue } =
    rawData;
      ...
      <ResponsiveContainer width="100%" height={600}>
        ...
        >
          ...
          <Bar
            ...
            fill="#EB5763"
            name="Smart Contract Transactions"
          />
          <Line
            type="monotone"
            dataKey="decimalValue"
